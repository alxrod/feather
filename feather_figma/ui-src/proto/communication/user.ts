...
export interface UserEntity {
    ...
    /**
     * @generated from protobuf field: bool figma_connected = 31;
     */
    figmaConnected: boolean;
    /**
     * @generated from protobuf field: string figma_code = 32;
     */
    figmaCode: string;
    /**
     * @generated from protobuf field: uint32 free_contracts = 33;
     */
...
class UserEntity$Type extends MessageType<UserEntity> {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* int64 outstanding_balance */ 30:
                    ...
                    break;
                case /* bool figma_connected */ 31:
                    message.figmaConnected = reader.bool();
                    break;
                case /* string figma_code */ 32:
                    message.figmaCode = reader.string();
                    break;
                case /* uint32 free_contracts */ 33:
                    message.freeContracts = reader.uint32();
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message: UserEntity, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.freeContracts !== 0)
            writer.tag(33, WireType.Varint).uint32(message.freeContracts);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
