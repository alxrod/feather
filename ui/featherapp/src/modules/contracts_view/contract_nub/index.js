...
import DeadlineDisplay from "../../contract/components/deadline/deadline_display"
...
const ContractNub = (props) => {
  ...
  const genLink = (contract) => {
    if (contract.stage == contractStages.INVITE) {
    ...
    <div className="overflow-hidden rounded-lg bg-white shadow border-2 border-white hover:border-primary5">
      ...
      <div className="pb-5">
        <div className="flex flex-wrap justify-between">
          ...
          <a href={link} className="text-lg font-medium leading-6 text-gray-900">{props.contract.title}</a>
