    ...
    <div className="md:px-1 lg: px-2 grow">
      <div className="flex flex-col h-full items-center justify-between">
                    ...
                    <span className="flex items-start">
                      <span className="flex-shrink-0 h-5 w-5 relative flex items-center justify-center" aria-hidden="true">
                        {(idx === props.selectedIdx) && (
                          <span className="absolute h-7 w-7 rounded-full bg-primary2" />
                        )}
        ...
        <button
              ...
              className="hidden md:inline-flex mt-2 ml-3 items-center px-4 py-1.5 border border-transparent rounded-md shadow-sm text-sm font-medium text-primary7 bg-primary1 hover:bg-primary4 hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary4"
        >
          Edit
        </button>
      </div>
...
{/* <div className="flex items-start" aria-current="step">
    ...
    <span className="ml-3 text-sm font-medium text-primary5">{genDateString(deadline.currentDate)}</span>
  </div> */}