...
const NewMessages = (props) => {
  ...
  useEffect(() => {
    if (props.newMessages.length > 0) {
      console.log("SETTING DEFAULT MESSAGE TO: ", props.newMessages[0])
  ...
  return (
    <div className="overflow-hidden rounded-lg bg-white shadow max-w-xl">
      <div className="px-4 pt-3 pb-3 border-b border-gray-200">
        ...
        <div className="flex">
          <div>
            <ul role="list" className="divide-y divide-gray-200 border-r border-gray-200 max-h-[200px] min-w-[150px] overflow-y-scroll hidden-scrollbar">
                ...
                >
                  ...
                  <div className="flex space-x-3 items-center">
                    <div className="relative min-w-0 flex-1 flex items-center">
                      ...
                      <p className="ml-3.5 text-xs font-medium text-gray-900">
                        { 
                          message.contractInfo.title.substring(0, 15)+
                          (message.contractInfo.title.length > 15 ? "..." : "")
                        }
                      </p>
                    </div>
                  </div>
          ...
          <div className="text-center p-6 flex flex-col items-center">
            <CheckCircleIcon className="text-gray-400 w-8 h-8" stroke-width="1.5"/>
