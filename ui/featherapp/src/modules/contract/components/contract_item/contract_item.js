    ...
    <div className="bg-white shadow sm:rounded-lg mb-5">
        <div className="px-2 py-5 sm:p-6">
          <Fragment key="1">
              ...
              <span className="ml-3.5 font-medium text-gray-900">{"Item " + props.contract_info.id}</span>
              </a>{' '}
          </Fragment>
          <div className="mt-2 mr-2 text-sm text-gray-500">
            <ItemTextArea override={props.override} text_body={props.contract_info.text} disabled={props.disabled} set_text={setContractText}/>
          </div>
