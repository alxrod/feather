...
goog.exportSymbol('proto.main.RequestAdminMsgBody', null, global);
 ...
 * @constructor
 */
proto.main.RequestAdminMsgBody = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.main.RequestAdminMsgBody, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.main.RequestAdminMsgBody.displayName = 'proto.main.RequestAdminMsgBody';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @const
 */
proto.main.ChatMessage.oneofGroups_ = [[6,7,11,8,9,10,12,13,14,15,16,17,18,19,20,24]];
...
proto.main.ChatMessage.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    requestAdminBody: (f = msg.getRequestAdminBody()) && proto.main.RequestAdminMsgBody.toObject(includeInstance, f)
  };
...
proto.main.ChatMessage.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 20:
      ...
      break;
    case 24:
      var value = new proto.main.RequestAdminMsgBody;
      reader.readMessage(value,proto.main.RequestAdminMsgBody.deserializeBinaryFromReader);
...
proto.main.ChatMessage.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      24,
      f,
      proto.main.RequestAdminMsgBody.serializeBinaryToWriter
    );
  }
};
...
/**
 * optional RequestAdminMsgBody request_admin_body = 24;
 * @return {?proto.main.RequestAdminMsgBody}
 */
proto.main.ChatMessage.prototype.getRequestAdminBody = function() {
  return /** @type{?proto.main.RequestAdminMsgBody} */ (
    jspb.Message.getWrapperField(this, proto.main.RequestAdminMsgBody, 24));
};


/**
 * @param {?proto.main.RequestAdminMsgBody|undefined} value
 * @return {!proto.main.ChatMessage} returns this
*/
 ...
 * @return {!Object}
 */
proto.main.RequestAdminMsgBody.prototype.toObject = function(opt_includeInstance) {
  return proto.main.RequestAdminMsgBody.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.main.RequestAdminMsgBody} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.main.RequestAdminMsgBody.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * @return {!proto.main.RequestAdminMsgBody}
 */
proto.main.RequestAdminMsgBody.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.main.RequestAdminMsgBody;
  return proto.main.RequestAdminMsgBody.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.main.RequestAdminMsgBody} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.main.RequestAdminMsgBody}
 */
proto.main.RequestAdminMsgBody.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.main.RequestAdminMsgBody.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.main.RequestAdminMsgBody.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.main.RequestAdminMsgBody} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.main.RequestAdminMsgBody.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
};
