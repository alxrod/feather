...
const methodDescriptor_FileService_ConfirmProfileUploaded = new grpc.web.MethodDescriptor(
  ...
  proto.main.ProfileImageEntity.deserializeBinary
);
 ...
 * @param {?Object<string, string>} metadata User defined
 *     call metadata
 * @param {function(?grpc.web.RpcError, ?proto.main.ProfileImageEntity)}
 *     callback The callback function(error, response)
 * @return {!grpc.web.ClientReadableStream<!proto.main.ProfileImageEntity>|undefined}
 *     The XHR Node Readable Stream
 */
 ...
 * @param {?Object<string, string>=} metadata User defined
 *     call metadata
 * @return {!Promise<!proto.main.ProfileImageEntity>}
 *     Promise that resolves to the response
 */
