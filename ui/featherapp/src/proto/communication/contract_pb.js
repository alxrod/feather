...
goog.exportSymbol('proto.main.ContractQueryRequest', null, global);
 ...
 * @constructor
 */
proto.main.ContractQueryRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.main.ContractQueryRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.main.ContractQueryRequest.displayName = 'proto.main.ContractQueryRequest';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.main.ContractQueryRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.main.ContractQueryRequest.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.main.ContractQueryRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.main.ContractQueryRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    contractIds: jspb.Message.getFieldWithDefault(msg, 1, ""),
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.main.ContractQueryRequest}
 */
proto.main.ContractQueryRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.main.ContractQueryRequest;
  return proto.main.ContractQueryRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.main.ContractQueryRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.main.ContractQueryRequest}
 */
proto.main.ContractQueryRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.main.ContractQueryRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.main.ContractQueryRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.main.ContractQueryRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.main.ContractQueryRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
...
/**
 * optional string contract_ids = 1;
 * @return {string}
 */
proto.main.ContractQueryRequest.prototype.getContractIds = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.main.ContractQueryRequest} returns this
 */
proto.main.ContractQueryRequest.prototype.setContractIds = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {string}
 */
proto.main.ContractQueryRequest.prototype.getUserId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.main.ContractQueryRequest} returns this
 */
proto.main.ContractQueryRequest.prototype.setUserId = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
 ...
 * @return {boolean}
 */
proto.main.ContractReactPrice.prototype.getAccept = function() {
 ...
 * @return {!proto.main.ContractReactPrice} returns this
 */
proto.main.ContractReactPrice.prototype.setAccept = function(value) {
 ...
 * @return {boolean}
 */
proto.main.ContractReactDeadline.prototype.getAccept = function() {
  return /** @type {boolean} */ (jspb.Message.getBooleanFieldWithDefault(this, 2, false));
};
 ...
 * @return {!proto.main.ContractReactDeadline} returns this
 */
proto.main.ContractReactDeadline.prototype.setAccept = function(value) {
  return jspb.Message.setProto3BooleanField(this, 2, value);
};
