...
proto.main.ContractResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    yourrole: jspb.Message.getFieldWithDefault(msg, 3, 0)
  };
...
/**
 * optional uint32 yourRole = 3;
 * @return {number}
 */
proto.main.ContractResponse.prototype.getYourrole = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 3, 0));
};
 ...
 * @return {!proto.main.ContractResponse} returns this
 */
proto.main.ContractResponse.prototype.setYourrole = function(value) {
  return jspb.Message.setProto3IntField(this, 3, value);
};
