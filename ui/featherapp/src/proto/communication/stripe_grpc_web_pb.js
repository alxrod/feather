 ...
 * @const
 * @type {!grpc.web.MethodDescriptor<
 *   !proto.main.InternalChargeEntity,
 *   !proto.main.NullResponse>}
 */
const methodDescriptor_StripeService_TransferDeadlineFunds = new grpc.web.MethodDescriptor(
  '/main.StripeService/TransferDeadlineFunds',
  grpc.web.MethodType.UNARY,
  proto.main.InternalChargeEntity,
  communication_contract_pb.NullResponse,
  /**
   * @param {!proto.main.InternalChargeEntity} request
   * @return {!Uint8Array}
   */
  function(request) {
    return request.serializeBinary();
...
/**
 * @param {!proto.main.InternalChargeEntity} request The
 *     request proto
 * @param {?Object<string, string>} metadata User defined
 *     call metadata
 * @param {function(?grpc.web.RpcError, ?proto.main.NullResponse)}
 ...
 *     The XHR Node Readable Stream
 */
proto.main.StripeServiceClient.prototype.transferDeadlineFunds =
    function(request, metadata, callback) {
  return this.client_.rpcCall(this.hostname_ +
      '/main.StripeService/TransferDeadlineFunds',
      request,
 ...
 *     Promise that resolves to the response
 */
proto.main.StripeServicePromiseClient.prototype.transferDeadlineFunds =
    function(request, metadata) {
  return this.client_.unaryCall(this.hostname_ +
      '/main.StripeService/TransferDeadlineFunds',
      request,
 ...
 * @const
 * @type {!grpc.web.MethodDescriptor<
 *   !proto.main.InternalChargeCustomQuery,
 *   !proto.main.InternalChargeEntity>}
 */
const methodDescriptor_StripeService_QueryICharge = new grpc.web.MethodDescriptor(
  '/main.StripeService/QueryICharge',
  grpc.web.MethodType.UNARY,
  proto.main.InternalChargeCustomQuery,
  proto.main.InternalChargeEntity,
  /**
   * @param {!proto.main.InternalChargeCustomQuery} request
   * @return {!Uint8Array}
   */
  function(request) {
    return request.serializeBinary();
  },
  proto.main.InternalChargeEntity.deserializeBinary
);


/**
 * @param {!proto.main.InternalChargeCustomQuery} request The
 *     request proto
 * @param {?Object<string, string>} metadata User defined
 *     call metadata
 * @param {function(?grpc.web.RpcError, ?proto.main.InternalChargeEntity)}
 *     callback The callback function(error, response)
 * @return {!grpc.web.ClientReadableStream<!proto.main.InternalChargeEntity>|undefined}
 *     The XHR Node Readable Stream
 */
proto.main.StripeServiceClient.prototype.queryICharge =
    function(request, metadata, callback) {
  return this.client_.rpcCall(this.hostname_ +
      '/main.StripeService/QueryICharge',
      request,
 ...
 * @param {?Object<string, string>=} metadata User defined
 *     call metadata
 * @return {!Promise<!proto.main.InternalChargeEntity>}
 *     Promise that resolves to the response
 */
proto.main.StripeServicePromiseClient.prototype.queryICharge =
    function(request, metadata) {
  return this.client_.unaryCall(this.hostname_ +
      '/main.StripeService/QueryICharge',
      request,
 ...
 * @const
 * @type {!grpc.web.MethodDescriptor<
 *   !proto.main.InternalChargeUpdateStateRequest,
 *   !proto.main.InternalChargeEntity>}
 */
const methodDescriptor_StripeService_UpdateState = new grpc.web.MethodDescriptor(
  '/main.StripeService/UpdateState',
  grpc.web.MethodType.UNARY,
  proto.main.InternalChargeUpdateStateRequest,
  proto.main.InternalChargeEntity,
  /**
   * @param {!proto.main.InternalChargeUpdateStateRequest} request
   * @return {!Uint8Array}
   */
  function(request) {
    return request.serializeBinary();
...
/**
 * @param {!proto.main.InternalChargeUpdateStateRequest} request The
 *     request proto
 * @param {?Object<string, string>} metadata User defined
 *     call metadata
 * @param {function(?grpc.web.RpcError, ?proto.main.InternalChargeEntity)}
 ...
 *     The XHR Node Readable Stream
 */
proto.main.StripeServiceClient.prototype.updateState =
    function(request, metadata, callback) {
  return this.client_.rpcCall(this.hostname_ +
      '/main.StripeService/UpdateState',
      request,
 ...
 *     Promise that resolves to the response
 */
proto.main.StripeServicePromiseClient.prototype.updateState =
    function(request, metadata) {
  return this.client_.unaryCall(this.hostname_ +
      '/main.StripeService/UpdateState',
      request,
