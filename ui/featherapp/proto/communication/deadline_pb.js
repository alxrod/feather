...
goog.exportSymbol('proto.communication.ReactPayoutReq', null, global);
...
goog.exportSymbol('proto.communication.SuggestPayoutReq', null, global);
/**
 ...
 * @constructor
 */
proto.communication.SuggestPayoutReq = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.communication.SuggestPayoutReq, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.communication.SuggestPayoutReq.displayName = 'proto.communication.SuggestPayoutReq';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.communication.ReactPayoutReq = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.communication.ReactPayoutReq, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.communication.ReactPayoutReq.displayName = 'proto.communication.ReactPayoutReq';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {string}
 */
proto.communication.SuggestDateReq.prototype.getId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.communication.SuggestDateReq} returns this
 */
proto.communication.SuggestDateReq.prototype.setId = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
 ...
 * @return {boolean}
 */
proto.communication.SuggestDateReq.prototype.getDocMode = function() {
 ...
 * @return {!proto.communication.SuggestDateReq} returns this
 */
proto.communication.SuggestDateReq.prototype.setDocMode = function(value) {
 ...
 * @return {!Object}
 */
proto.communication.SuggestPayoutReq.prototype.toObject = function(opt_includeInstance) {
  return proto.communication.SuggestPayoutReq.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.communication.SuggestPayoutReq} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.communication.SuggestPayoutReq.toObject = function(includeInstance, msg) {
  var f, obj = {
    userId: jspb.Message.getFieldWithDefault(msg, 1, ""),
    id: jspb.Message.getFieldWithDefault(msg, 2, ""),
    deadlineId: jspb.Message.getFieldWithDefault(msg, 4, ""),
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.communication.SuggestPayoutReq}
 */
proto.communication.SuggestPayoutReq.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.communication.SuggestPayoutReq;
  return proto.communication.SuggestPayoutReq.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.communication.SuggestPayoutReq} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.communication.SuggestPayoutReq}
 */
proto.communication.SuggestPayoutReq.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.communication.SuggestPayoutReq.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.communication.SuggestPayoutReq.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.communication.SuggestPayoutReq} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.communication.SuggestPayoutReq.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getUserId();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.communication.SuggestPayoutReq.prototype.getUserId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.communication.SuggestPayoutReq} returns this
 */
proto.communication.SuggestPayoutReq.prototype.setUserId = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {string}
 */
proto.communication.SuggestPayoutReq.prototype.getId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.communication.SuggestPayoutReq} returns this
 */
proto.communication.SuggestPayoutReq.prototype.setId = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
 ...
 * @return {string}
 */
proto.communication.SuggestPayoutReq.prototype.getDeadlineId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 4, ""));
};
 ...
 * @return {!proto.communication.SuggestPayoutReq} returns this
 */
proto.communication.SuggestPayoutReq.prototype.setDeadlineId = function(value) {
  return jspb.Message.setProto3StringField(this, 4, value);
};
 ...
 * @return {number}
 */
proto.communication.SuggestPayoutReq.prototype.getNewPayout = function() {
 ...
 * @return {!proto.communication.SuggestPayoutReq} returns this
 */
proto.communication.SuggestPayoutReq.prototype.setNewPayout = function(value) {
 ...
 * @return {boolean}
 */
proto.communication.SuggestPayoutReq.prototype.getDocMode = function() {
  return /** @type {boolean} */ (jspb.Message.getBooleanFieldWithDefault(this, 5, false));
};
 ...
 * @return {!proto.communication.SuggestPayoutReq} returns this
 */
proto.communication.SuggestPayoutReq.prototype.setDocMode = function(value) {
  return jspb.Message.setProto3BooleanField(this, 5, value);
};
 ...
 * @const
 */
proto.communication.SuggestDeadlineItemsReq.repeatedFields_ = [3];
 ...
 * @return {string}
 */
proto.communication.SuggestDeadlineItemsReq.prototype.getId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.communication.SuggestDeadlineItemsReq} returns this
 */
proto.communication.SuggestDeadlineItemsReq.prototype.setId = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
 ...
 * @return {boolean}
 */
proto.communication.SuggestDeadlineItemsReq.prototype.getDocMode = function() {
  return /** @type {boolean} */ (jspb.Message.getBooleanFieldWithDefault(this, 5, false));
};
 ...
 * @return {!proto.communication.SuggestDeadlineItemsReq} returns this
 */
proto.communication.SuggestDeadlineItemsReq.prototype.setDocMode = function(value) {
  return jspb.Message.setProto3BooleanField(this, 5, value);
};
 ...
 * @return {string}
 */
proto.communication.ReactDeadlineItemsReq.prototype.getId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.communication.ReactDeadlineItemsReq} returns this
 */
proto.communication.ReactDeadlineItemsReq.prototype.setId = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
 ...
 * @return {boolean}
 */
proto.communication.ReactDeadlineItemsReq.prototype.getDocMode = function() {
 ...
 * @return {!proto.communication.ReactDeadlineItemsReq} returns this
 */
proto.communication.ReactDeadlineItemsReq.prototype.setDocMode = function(value) {
 ...
 * @return {string}
 */
proto.communication.ReactDateReq.prototype.getId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.communication.ReactDateReq} returns this
 */
proto.communication.ReactDateReq.prototype.setId = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
 ...
 * @return {boolean}
 */
proto.communication.ReactDateReq.prototype.getDocMode = function() {
  return /** @type {boolean} */ (jspb.Message.getBooleanFieldWithDefault(this, 6, false));
};
 ...
 * @return {!proto.communication.ReactDateReq} returns this
 */
proto.communication.ReactDateReq.prototype.setDocMode = function(value) {
  return jspb.Message.setProto3BooleanField(this, 6, value);
};
 ...
 * @return {!Object}
 */
proto.communication.ReactPayoutReq.prototype.toObject = function(opt_includeInstance) {
  return proto.communication.ReactPayoutReq.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.communication.ReactPayoutReq} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.communication.ReactPayoutReq.toObject = function(includeInstance, msg) {
  var f, obj = {
    userId: jspb.Message.getFieldWithDefault(msg, 1, ""),
    id: jspb.Message.getFieldWithDefault(msg, 2, ""),
    messageId: jspb.Message.getFieldWithDefault(msg, 4, ""),
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.communication.ReactPayoutReq}
 */
proto.communication.ReactPayoutReq.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.communication.ReactPayoutReq;
  return proto.communication.ReactPayoutReq.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.communication.ReactPayoutReq} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.communication.ReactPayoutReq}
 */
proto.communication.ReactPayoutReq.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.communication.ReactPayoutReq.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.communication.ReactPayoutReq.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.communication.ReactPayoutReq} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.communication.ReactPayoutReq.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getUserId();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.communication.ReactPayoutReq.prototype.getUserId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.communication.ReactPayoutReq} returns this
 */
proto.communication.ReactPayoutReq.prototype.setUserId = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {string}
 */
proto.communication.ReactPayoutReq.prototype.getId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.communication.ReactPayoutReq} returns this
 */
proto.communication.ReactPayoutReq.prototype.setId = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
 ...
 * @return {string}
 */
proto.communication.ReactPayoutReq.prototype.getMessageId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 4, ""));
};
 ...
 * @return {!proto.communication.ReactPayoutReq} returns this
 */
proto.communication.ReactPayoutReq.prototype.setMessageId = function(value) {
  return jspb.Message.setProto3StringField(this, 4, value);
};
 ...
 * @return {string}
 */
proto.communication.ReactPayoutReq.prototype.getDeadlineId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 5, ""));
};
 ...
 * @return {!proto.communication.ReactPayoutReq} returns this
 */
proto.communication.ReactPayoutReq.prototype.setDeadlineId = function(value) {
  return jspb.Message.setProto3StringField(this, 5, value);
};
 ...
 * @return {number}
 */
proto.communication.ReactPayoutReq.prototype.getStatus = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 3, 0));
};
 ...
 * @return {!proto.communication.ReactPayoutReq} returns this
 */
proto.communication.ReactPayoutReq.prototype.setStatus = function(value) {
  return jspb.Message.setProto3IntField(this, 3, value);
};
 ...
 * @return {boolean}
 */
proto.communication.ReactPayoutReq.prototype.getDocMode = function() {
  return /** @type {boolean} */ (jspb.Message.getBooleanFieldWithDefault(this, 6, false));
};
 ...
 * @return {!proto.communication.ReactPayoutReq} returns this
 */
proto.communication.ReactPayoutReq.prototype.setDocMode = function(value) {
  return jspb.Message.setProto3BooleanField(this, 6, value);
};
 ...
 * @return {string}
 */
proto.communication.SuggestAddDeadlineReq.prototype.getId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.communication.SuggestAddDeadlineReq} returns this
 */
proto.communication.SuggestAddDeadlineReq.prototype.setId = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
 ...
 * @return {boolean}
 */
proto.communication.SuggestAddDeadlineReq.prototype.getDocMode = function() {
 ...
 * @return {!proto.communication.SuggestAddDeadlineReq} returns this
 */
proto.communication.SuggestAddDeadlineReq.prototype.setDocMode = function(value) {
 ...
 * @return {string}
 */
proto.communication.ReactAddDeadlineReq.prototype.getId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.communication.ReactAddDeadlineReq} returns this
 */
proto.communication.ReactAddDeadlineReq.prototype.setId = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
 ...
 * @return {boolean}
 */
proto.communication.ReactAddDeadlineReq.prototype.getDocMode = function() {
  return /** @type {boolean} */ (jspb.Message.getBooleanFieldWithDefault(this, 6, false));
};
 ...
 * @return {!proto.communication.ReactAddDeadlineReq} returns this
 */
proto.communication.ReactAddDeadlineReq.prototype.setDocMode = function(value) {
  return jspb.Message.setProto3BooleanField(this, 6, value);
};
 ...
 * @return {string}
 */
proto.communication.SuggestDelDeadlineReq.prototype.getId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.communication.SuggestDelDeadlineReq} returns this
 */
proto.communication.SuggestDelDeadlineReq.prototype.setId = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
 ...
 * @return {boolean}
 */
proto.communication.SuggestDelDeadlineReq.prototype.getDocMode = function() {
  return /** @type {boolean} */ (jspb.Message.getBooleanFieldWithDefault(this, 4, false));
};
 ...
 * @return {!proto.communication.SuggestDelDeadlineReq} returns this
 */
proto.communication.SuggestDelDeadlineReq.prototype.setDocMode = function(value) {
  return jspb.Message.setProto3BooleanField(this, 4, value);
};
 ...
 * @return {string}
 */
proto.communication.ReactDelDeadlineReq.prototype.getId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.communication.ReactDelDeadlineReq} returns this
 */
proto.communication.ReactDelDeadlineReq.prototype.setId = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
 ...
 * @return {boolean}
 */
proto.communication.FinishDeadlineRequest.prototype.getDocMode = function() {
  return /** @type {boolean} */ (jspb.Message.getBooleanFieldWithDefault(this, 4, false));
};
 ...
 * @return {!proto.communication.FinishDeadlineRequest} returns this
 */
proto.communication.FinishDeadlineRequest.prototype.setDocMode = function(value) {
  return jspb.Message.setProto3BooleanField(this, 4, value);
};
