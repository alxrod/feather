...
proto.communication.DocumentNub.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    figmaLink: jspb.Message.getFieldWithDefault(msg, 5, ""),
...
/**
 * optional string figma_link = 5;
 * @return {string}
 */
proto.communication.DocumentNub.prototype.getFigmaLink = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 5, ""));
};
 ...
 * @return {!proto.communication.DocumentNub} returns this
 */
proto.communication.DocumentNub.prototype.setFigmaLink = function(value) {
  return jspb.Message.setProto3StringField(this, 5, value);
};
