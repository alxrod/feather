...
export const USER_CONNECT_FIGMA = "user/CONNECT_FIGMA"
export const USER_SET_FROM_STORAGE = "user/SET_FROM_STORAGE"

export const USER_CHANGE_FREE_CONTRACTS = "user/CHANGE_FREE_CONTRACTS"